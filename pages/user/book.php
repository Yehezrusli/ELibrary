	...
	<body>
		...
		<div class="wrap">
			...
			<div class="content">
				...
				<select name="filterBy" style="width: 190px; font-size: 15px; display: inline; float:right">
				...
				<label style="font-size: 15px; display: inline; float:right">by</label>
				<input type="text" placeholder="Search books.." style="width: 190px; font-size: 15px; display: inline; float:right">
